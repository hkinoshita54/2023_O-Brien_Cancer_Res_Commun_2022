...
ggsave("cluster.png", path = "plots/03_sct_harmony", width = 5, height = 5, units = "in", dpi = 150)
DimPlot(seu, group.by = "orig.ident") + NoAxes()
ggsave("id.png", path = "plots/03_sct_harmony", width = 5, height = 5, units = "in", dpi = 150)
...
for(i in 1:length(features)){
  ...
  ggsave(paste0(as.character(features[i]), ".png"), plot = p, path = "plots/03_sct_harmony", width = 5, height = 5, units = "in", dpi = 150)
}


saveRDS(seu, file = "RDSfiles/seu_04_sct_harmony.RDS")